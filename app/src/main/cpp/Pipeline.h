...
class Detector {
public: // NOLINT
  explicit Detector(const std::string &modelPath, const std::string &labelPath,
...
private: // NOLINT
  int inputWidth_;
  int inputHeight_;
  std::vector<float> inputMean_ = {0.485, 0.456, 0.406};
  std::vector<float> inputStd_ = {0.229, 0.224, 0.225};
...
class Pipeline {
public: // NOLINT
  Pipeline(const std::string &modlePath, const std::string &labelPath,
           const int cpuThreadNum, const std::string &cpuPowerMode,
