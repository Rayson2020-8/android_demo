...
#include "Pipeline.h"
Detector::Detector(const std::string &modelPath, const std::string &labelPath,
                   const int cpuThreadNum, const std::string &cpuPowerMode,
                   int inputWidth, int inputHeight,float scoreThreshold, float nmsThreshold)
    : inputWidth_(inputWidth), inputHeight_(inputHeight), scoreThreshold_(scoreThreshold), nmsThreshold_(nmsThreshold) {
...
Pipeline::Pipeline(const std::string &modlePath, const std::string &labelPath,
                   const int cpuThreadNum, const std::string &cpuPowerMode,
                   int inputWidth, int inputHeight, float scoreThreshold, float nmsThreshold) {
  detector_.reset(new Detector(modlePath, labelPath, cpuThreadNum, cpuPowerMode,
                               inputWidth, inputHeight, scoreThreshold, nmsThreshold));
}
