...
Java_com_example_object_1detect_1demo_Native_nativeInit(
    ...
    jfloat scoreThreshold, jfloat nmsThreshold) {
  ...
  return reinterpret_cast<jlong>(
      new Pipeline(modelDir, labelPath, cpuThreadNum, cpuPowerMode, inputWidth,
                   inputHeight, scoreThreshold, nmsThreshold));
}
...
Java_com_example_object_1detect_1demo_Native_nativeRelease(
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_example_object_1detect_1demo_Native_nativeProcess(
