...
public class Activity_photo extends AppCompatActivity {
    ...
    private RadioGroup save_result_rg;
    ...
    private void initView() {
        ...
        save_result_rg = (RadioGroup) findViewById(R.id.save_result_rdg);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.run_detect:
                    Toast.makeText(Activity_photo.this, "暂未实现！", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
    ...
    private class MyChangedOnClickListenr implements RadioGroup.OnCheckedChangeListener {
        @Override
